class BinarySearchTree:
    def __init__(self, value, depth=1):
        ...
        self.right = None
        if depth == 1:
            print(f"Tree node {self.value} added at depth {self.depth}")
    ...
    # In order DFS: Acting on left -> current -> right
    # Also a topological sort
    def depth_first_traversal(self, path=[]):
...
path = tree.depth_first_traversal()
print(path)
