# Python doesn't have a hash map structure
# Simulate it by using a list and storing it's length at all times
...
# Open addressing:  One of three things can happen:
...
# 1. How would you delete a key-value pair from this hash map?
